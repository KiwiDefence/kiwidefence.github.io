...
async function main() {
  ...
  <g transform="translate(50,50) scale(0.7,0.7)" fill="#ffffff">
  ...
  <text x="130" y="540" font-family="'IBM Plex Mono', monospace" font-size="72" font-weight="700" fill="#ffffff" letter-spacing="4">KIWI DEFENCE</text>
  <text x="130" y="590" font-family="'IBM Plex Mono', monospace" font-size="28" fill="#a0a0a0" letter-spacing="6">CYBERSECURITY</text>
</svg>`)
